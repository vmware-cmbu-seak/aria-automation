...
def handler(context, inputs):
    ...
    if 'catalogs' not in inputs: inputs['catalogs'] = [] # Optional Init
    ...
    if catalogItems:
        policy = vra.post('/policy/api/policies', {
            'name': 'Catalog of ' + inputs['name'],
        ...
        inputs['policyId'] = policy['id']
    else: inputs['policyId'] = ''
